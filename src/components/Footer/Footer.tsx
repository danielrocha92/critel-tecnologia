      ...
      <div className={`container ${styles.container}`}>
        ...
        <div className={styles.column}>
          <div className={styles.brandWrapper}>
            ...
            <h3 className={styles.brandTitle}>{dict.brandTitle || "Critel"}</h3>
          </div>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.contactList}>
            ...
            <li className={styles.contactItem}>
              ...
              <a 
                href="https://wa.me/5511999999999?text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Critel%20e%20gostaria%20de%20um%20atendimento." 
                target="_blank" 
                rel="noopener noreferrer"
              >
